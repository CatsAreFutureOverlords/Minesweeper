...
public class MinesweeperGame {
    ...
    public void clear(Cell cell) {
        ...
        if (cell.getValue() == Cell.BLANK) {
            ...
            for (Cell c : toClear) { c.setRevealed(true); }
        } else if (cell.getValue() == Cell.MINE) { gameOver = true; }
    }
    ...
    public boolean isGameWon() {
        ...
        for (Cell c: getMineGrid().getCells()) {
            if (c.getValue() != Cell.MINE && c.getValue() != Cell.BLANK && !c.isRevealed()) {
                numbersUnrevealed++;
            }
        }
    ...
    public MineGrid getMineGrid() { return mineGrid; }

    public boolean isFlagMode() { return flagMode; }

    public int getFlagCount() { return flagCount; }

    public int getNumberBombs() { return numberBombs; }
}
